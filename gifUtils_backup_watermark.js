...
async function createAnimatedGif(photos) {
  ...
  try {
    ...
    // Add watermark ONLY to original image (processed already has watermark)
    ...
    // Use processed image as-is (already has watermark)
    const watermarkedAfterBuffer = afterBuffer;
